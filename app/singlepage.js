...
import { ArrowRight, Check, Star, Shield, Clock, Users, BookOpen, Gift, Zap, TrendingUp, Heart, Award, Target, ChevronDown } from 'lucide-react';

export default function HeightEbookLanding() {
    const [timeLeft, setTimeLeft] = useState({ hours: 12, minutes: 37, seconds: 0 });
    ...
    const testimonials = [
        { name: "Ana Carolina, 22 anos", text: "Cresci 7cm em 4 meses! Minha vida amorosa mudou completamente!", city: "São Paulo, SP" },
        { name: "Marcus Vinícius, 19 anos", text: "De 1,67m para 1,74m! Agora tenho confiança para tudo!", city: "Rio de Janeiro, RJ" },
        { name: "Gabriela Santos, 24 anos", text: "Incrível! 5cm a mais e uma postura de modelo!", city: "Belo Horizonte, MG" },
        { name: "Pedro Henrique, 26 anos", text: "Funcionou mesmo depois dos 25! Cresci 6cm!", city: "Brasília, DF" },
        { name: "Larissa Oliveira, 20 anos", text: "Método simples que realmente funciona! +8cm!", city: "Fortaleza, CE" },
        { name: "João Victor, 23 anos", text: "Minha autoestima foi às alturas junto com minha altura!", city: "Porto Alegre, RS" }
    ];
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-red-600 to-pink-600 text-white py-3 text-center relative overflow-hidden">
              ...
              {String(timeLeft.hours).padStart(2, '0')}:{String(timeLeft.minutes).padStart(2, '0')}:{String(timeLeft.seconds).padStart(2, '0')}
                    ...
                    <span className="text-yellow-300 font-bold">67% OFF - Apenas hoje!</span>
                </div>
            </div>
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-block bg-gradient-to-r from-red-500 to-orange-500 px-6 py-3 rounded-full mb-8 transform rotate-2 shadow-2xl">
                            <span className="font-bold text-lg">⚡ PARE DE SOFRER EM SILÊNCIO!</span>
                        </div>
                ...
                ARRUINANDO sua vida?
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
                            <div className="bg-red-900/30 border border-red-500/30 rounded-2xl p-6 backdrop-blur-sm">
                                ...
                                <h3 className="font-bold text-lg mb-2 text-red-300">Vida Amorosa</h3>
                                <p className="text-gray-300">Se sente rejeitado(a) por causa da sua altura?</p>
                            </div>
                            ...
                            <div className="bg-orange-900/30 border border-orange-500/30 rounded-2xl p-6 backdrop-blur-sm">
                                ...
                                <h3 className="font-bold text-lg mb-2 text-orange-300">Autoestima</h3>
                                <p className="text-gray-300">Evita fotos e se sente inferior aos outros?</p>
                            </div>
                            ...
                            <div className="bg-yellow-900/30 border border-yellow-500/30 rounded-2xl p-6 backdrop-blur-sm">
                                ...
                                <h3 className="font-bold text-lg mb-2 text-yellow-300">Oportunidades</h3>
                                <p className="text-gray-300">Perdeu chances por falta de presença?</p>
                            </div>
                        </div>
                ...
                <span className="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">
                  AGORA VOCÊ PODE MUDAR TUDO!
                            ...
                            <p className="text-xl md:text-2xl leading-relaxed text-gray-200 mb-8">
                                Descubra o método científico que já transformou a vida de <strong className="text-emerald-400">+47.382 pessoas</strong>
                                que ganharam até <strong className="text-blue-400">12cm de altura</strong> em apenas 90 dias!
                            </p>

                            {/* Social Proof Numbers */}
                            <div className="grid grid-cols-3 gap-4 mb-8">
                                <div className="text-center">
                                    <div className="text-3xl font-black text-emerald-400">47,382</div>
                                    <div className="text-sm text-gray-400">Pessoas transformadas</div>
                                </div>
                                <div className="text-center">
                                ...
                                <div className="text-center">
                                    <div className="text-3xl font-black text-purple-400">12cm</div>
                    ...
                    <div className="bg-gradient-to-br from-white via-gray-100 to-white text-gray-900 rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl mx-auto border-4 border-emerald-400 relative overflow-hidden">
                        ...
                        <div className="text-center mb-8">
                            <div className="text-6xl font-black mb-4">
                                <span className="text-gray-400 line-through text-3xl mr-4">R$ 59,90</span>
                                <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">R$ 19,90</span>
                            </div>
                ...
                🔥 QUERO CRESCER AGORA! <ArrowRight className="w-6 h-6" />
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <div className="text-sm text-gray-500">
                                ✅ Acesso imediato • ✅ Compatível com todos dispositivos • ✅ Suporte 24h
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed bottom-6 right-6 bg-white text-gray-900 rounded-xl p-4 shadow-2xl max-w-sm border-l-4 border-emerald-500 z-50 transform transition-all duration-500 hover:scale-105">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm font-semibold mb-1">"{testimonials[testimonialIndex].text}"</p>
                            <p className="text-xs text-gray-500">
                                <strong>{testimonials[testimonialIndex].name}</strong> • {testimonials[testimonialIndex].city}
                            </p>
                        </div>
                    </div>
                </div>
              ...
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                BASEADO EM PESQUISAS REAIS!
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
                            Nosso método é fundamentado em <strong className="text-blue-400">análises de mais de 200 estudos científicos</strong>
                            sobre crescimento humano, hormônio do crescimento, alongamento vertebral e otimização postural.
                            <strong className="text-purple-400"> Não é mágica, é CIÊNCIA!</strong>
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
                        <div className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 border border-blue-500/30 rounded-2xl p-6 backdrop-blur-sm text-center">
                            ...
                            <h3 className="font-bold text-lg mb-3 text-blue-300">Hormônio HGH</h3>
                            <p className="text-gray-300 text-sm">Ativação natural da produção do hormônio do crescimento</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border border-purple-500/30 rounded-2xl p-6 backdrop-blur-sm text-center">
                            <div className="text-4xl mb-4">📏</div>
                            <h3 className="font-bold text-lg mb-3 text-purple-300">Descompressão</h3>
                            <p className="text-gray-300 text-sm">Técnicas para liberar espaço entre as vértebras</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-pink-900/50 to-red-900/50 border border-pink-500/30 rounded-2xl p-6 backdrop-blur-sm text-center">
                            <div className="text-4xl mb-4">🥗</div>
                            <h3 className="font-bold text-lg mb-3 text-pink-300">Nutrição Específica</h3>
                            <p className="text-gray-300 text-sm">Alimentos que estimulam o crescimento celular</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-emerald-500/30 rounded-2xl p-6 backdrop-blur-sm text-center">
                            <div className="text-4xl mb-4">💪</div>
                            <h3 className="font-bold text-lg mb-3 text-emerald-300">Exercícios Direcionados</h3>
                            <p className="text-gray-300 text-sm">Movimentos que alongam e fortalecem</p>
                        </div>
                    </div>
                </div>
            </div>
              ...
              <span className="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">
                RESULTADOS QUE FALAM!
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            Mais de <strong className="text-emerald-400">47 mil pessoas</strong> já transformaram suas vidas.
                            Veja alguns depoimentos <strong className="text-blue-400">100% REAIS:</strong>
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
                        {[
                            ...
                            <div key={index} className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-emerald-500/30 rounded-3xl p-8 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-lg text-emerald-400">{testimonial.name}</h3>
                                ...
                                <div className="bg-gradient-to-r from-red-900/30 to-emerald-900/30 rounded-2xl p-4 mb-6">
                                    <div className="flex items-center justify-between">
                                        <div className="text-center">
                                            ...
                                            <div className="text-2xl font-black">{testimonial.before}</div>
                                        </div>
                                        <ArrowRight className="w-8 h-8 text-emerald-400" />
                                        <div className="text-center">
                                            <div className="text-emerald-400 font-bold">DEPOIS</div>
                                            <div className="text-2xl font-black">{testimonial.after}</div>
                                        </div>
                                    </div>
                ...
                <span className="bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">
                  SEGREDOS REVELADOS!
                            ...
                            <p className="text-xl text-gray-300">
                                Tudo que você precisa para <strong className="text-emerald-400">EXPLODIR</strong> sua altura:
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={index} className="flex items-start gap-4 bg-gradient-to-r from-gray-900/50 to-gray-800/50 border border-emerald-500/20 rounded-2xl p-6 backdrop-blur-sm hover:border-emerald-500/50 transition-all duration-300">
                                    <Check className="w-8 h-8 text-emerald-400 flex-shrink-0 mt-1" />
                                    <span className="text-lg font-semibold text-gray-200">{item}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-2 border-purple-500 rounded-3xl p-8 backdrop-blur-sm text-center">
                            ...
                            <p className="text-xl text-gray-200 leading-relaxed">
                                Guia completo com <strong className="text-purple-400">50 técnicas comprovadas</strong> para
                                <strong className="text-pink-400"> turbinar sua autoestima</strong>, eliminar a timidez e
                                se tornar uma pessoa <strong className="text-yellow-400">magnética e confiante</strong>!
            ...
            <span className="bg-gradient-to-r from-red-400 to-pink-400 bg-clip-text text-transparent">
              SUA ÚLTIMA CHANCE!
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                        Pare de sofrer com sua altura! Em 90 dias você pode estar <strong className="text-emerald-400">8cm mais alto</strong>,
                        com <strong className="text-blue-400">autoestima nas alturas</strong> e uma <strong className="text-purple-400">vida completamente transformada</strong>!
                    </p>
                    ...
                    <div className="bg-gradient-to-br from-white via-gray-100 to-white text-gray-900 rounded-3xl shadow-2xl p-12 max-w-2xl mx-auto border-4 border-red-500 relative">
                        ...
                        <div className="text-center mb-8">
                            <div className="text-8xl font-black mb-6">
                                <span className="text-gray-400 line-through text-4xl mr-4">R$ 59,90</span>
                                <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">R$ 19,90</span>
                            </div>
                ...
                🚀 SIM! QUERO CRESCER AGORA! <ArrowRight className="w-8 h-8" />
                        ...
                        <div className="space-y-3 text-gray-600">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <span className="font-bold text-lg">Garantia BLINDADA de 30 dias</span>
                            </div>
                            <div className="text-lg">
                                ✅ Acesso IMEDIATO • ✅ Funciona em qualquer idade • ✅ Suporte VIP incluso
                            </div>
                        </div>
                    </div>
                </div>
                ...
                GARANTIA BLINDADA 30 DIAS
                        ...
                        <div className="bg-gradient-to-br from-emerald-900/50 to-green-900/50 border-2 border-emerald-500 rounded-3xl p-12 backdrop-blur-sm">
                            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed mb-8">
                                Estou TÃO confiante que você vai <strong className="text-emerald-400">AMAR</strong> os resultados
                                que dou <strong className="text-green-400">30 dias COMPLETOS</strong> para testar tudo!
                            </p>

                            <p className="text-lg text-gray-300 leading-relaxed mb-8">
                                Se em 30 dias você não estiver <strong className="text-emerald-400">completamente satisfeito</strong>,
                                não perceber <strong className="text-green-400">resultados incríveis</strong>, ou simplesmente
                                <strong className="text-yellow-400"> mudar de ideia</strong> - eu devolvo <strong className="text-red-400">100% do seu dinheiro</strong>!
                            </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="bg-gradient-to-r from-red-600 to-pink-600 text-white px-6 py-3 rounded-full inline-block mb-8 animate-pulse">
                            <span className="font-black text-xl">⚠️ ATENÇÃO: OFERTA LIMITADA!</span>
                        </div>
                ...
                Apenas 127 cópias restantes!
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-12">
                            <div className="bg-red-900/50 border border-red-500 rounded-2xl p-6">
                                <div className="text-4xl mb-4">⏰</div>
                                <h3 className="font-bold text-xl mb-2 text-red-300">Tempo Limitado</h3>
                            ...
                            <div className="bg-orange-900/50 border border-orange-500 rounded-2xl p-6">
                                <div className="text-4xl mb-4">🔥</div>
                                <h3 className="font-bold text-xl mb-2 text-orange-300">Alta Demanda</h3>
                            ...
                            <div className="bg-purple-900/50 border border-purple-500 rounded-2xl p-6">
                                <div className="text-4xl mb-4">🎯</div>
                                <h3 className="font-bold text-xl mb-2 text-purple-300">Exclusividade</h3>
                        ...
                        <div className="text-2xl md:text-3xl font-bold text-yellow-400 mb-8">
                            ...
                            <br />
                            <span className="text-emerald-400">SEJA ALGUÉM QUE REALMENTE CRESCE!</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                DÚVIDAS FREQUENTES
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={index} className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 border border-gray-600 rounded-2xl p-8 backdrop-blur-sm hover:border-emerald-500/50 transition-all duration-300">
                                    <h3 className="text-xl font-bold text-emerald-400 mb-4">{faq.q}</h3>
              ...
              <span className="bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-pulse">
                É AGORA OU NUNCA!
                        ...
                        <p className="text-2xl md:text-3xl text-gray-300 mb-8 max-w-5xl mx-auto leading-relaxed">
                            Você tem duas opções: continuar sofrendo com sua altura por mais anos...
                            <br />
                            <strong className="text-red-400">OU MUDAR TUDO HOJE MESMO!</strong>
                        </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-white via-gray-100 to-white text-gray-900 rounded-3xl shadow-2xl p-16 max-w-3xl mx-auto border-8 border-emerald-400 relative transform hover:scale-105 transition-all duration-300">
                        ...
                        <div className="text-center mb-12">
                            <div className="text-9xl font-black mb-8">
                                <span className="text-gray-400 line-through text-5xl mr-6">R$ 59,90</span>
                                <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">R$ 19,90</span>
                            </div>
                ...
                🚀 CRESCER AGORA POR R$ 19,90! <ArrowRight className="w-10 h-10" />
              </span>
                        </button>
                        ...
                        <div className="space-y-4 text-gray-600 text-xl">
                            ...
                            <div className="text-lg">
                                ✅ Acesso em 2 minutos • ✅ Suporte VIP • ✅ Resultados garantidos
                            </div>
                            <div className="text-red-600 font-bold text-2xl animate-pulse">
                                ⏰ Restam apenas {String(timeLeft.hours).padStart(2, '0')}:{String(timeLeft.minutes).padStart(2, '0')}:{String(timeLeft.seconds).padStart(2, '0')} para esta oferta!
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-black text-gray-400 py-12">
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        <p className="mb-6 text-lg">© 2024 Cresça Naturalmente. Todos os direitos reservados.</p>
